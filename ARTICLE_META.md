# Memory Firewall — article publication metadata

Owner review required. Do not publish until every first-person claim is true for
the named owner.
...
**One-line summary:** A recalled record may describe the world. It may not direct the agent.

**Opening hook for social:** A valid, in-scope, high-confidence record carried an imperative two levels down in a metadata field. Why memory needs admission control, not just retrieval.

## Pre-publication checks

- [ ] Every first-person statement has been reviewed and adopted by `bagstreet`.
