...
if c.get('evidence_status')!='mainnet_confirmed_10_of_10' or any(r.get('historical_outcome')!='pending_live_receipt' or r.get('current_evidence')!='confirmed_mainnet_receipt' for r in c['checkpoints']): raise SystemExit('checkpoint metadata invariant failed')
